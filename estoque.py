...
class Ui_MainWindow_estoque(object):
    def setupUi(self, MainWindow_estoque):
        ...
        MainWindow_estoque.setMinimumSize(QtCore.QSize(575, 355))
        ...
        self.frame_3.setStyleSheet("background-color: rgb(0, 134, 0);")
        self.frame_3.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_3.setObjectName("frame_3")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.frame_3)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_popup_estpque = QtWidgets.QLabel(parent=self.frame_3)
        self.label_popup_estpque.setObjectName("label_popup_estpque")
        self.horizontalLayout_2.addWidget(self.label_popup_estpque)
        self.label_x_popup = QtWidgets.QLabel(parent=self.frame_3)
        self.label_x_popup.setMaximumSize(QtCore.QSize(20, 16777215))
        self.label_x_popup.setObjectName("label_x_popup")
        self.horizontalLayout_2.addWidget(self.label_x_popup)
...
"}")
    ...
    def retranslateUi(self, MainWindow_estoque):
        ...
        self.label_popup_estpque.setText(_translate("MainWindow_estoque", "TextLabel"))
        self.label_x_popup.setText(_translate("MainWindow_estoque", "x"))
        self.label_6.setText(_translate("MainWindow_estoque", "Estoque"))
        ...
        self.lineEdit_form_produto.setPlaceholderText(_translate("MainWindow_estoque", "Produto"))
        self.lineEdit_form_ecomerce.setPlaceholderText(_translate("MainWindow_estoque", "E-commerce"))
        self.lineEdit_form_nome.setPlaceholderText(_translate("MainWindow_estoque", "Nome "))
        self.label_10.setText(_translate("MainWindow_estoque", "Item"))
        self.lineEdit_form_quantidade.setPlaceholderText(_translate("MainWindow_estoque", "Quantidade"))
        self.lineEdit_form_valor.setPlaceholderText(_translate("MainWindow_estoque", "Valor"))
        self.lineEdit_form_data.setPlaceholderText(_translate("MainWindow_estoque", "Data"))
        ...
        self.lineEdit_form_procurar_nome.setPlaceholderText(_translate("MainWindow_estoque", "Nome"))
