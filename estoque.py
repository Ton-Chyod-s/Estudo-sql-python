...
class Ui_MainWindow_estoque(object):
    def setupUi(self, MainWindow_estoque):
        ...
        self.pushButton_x = QtWidgets.QPushButton(parent=self.frame_3)
        self.pushButton_x.setMaximumSize(QtCore.QSize(15, 16777215))
        self.pushButton_x.setStyleSheet("background-color: rgb(208, 208, 0);")
...
"}")
    ...
    def retranslateUi(self, MainWindow_estoque):
        ...
        self.pushButton_x.setText(_translate("MainWindow_estoque", "x"))
